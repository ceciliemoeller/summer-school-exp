...
welcome <-
  one_button_page(div(
    ...
    div(
      ...
      p("Recommendations: take the test in quiet surroundings, use headphones and a touchscreen (smartphone/tablet) if at all possible, and do not use the browser 'Safari'."),
      p("You can expect this to take approximately 8-10 minutes."),
